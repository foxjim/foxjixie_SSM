...
<html>
	...
	<body>
		...
		<div class="container">
				...
				<div style="font-size: 14px; margin-top: 53px; line-height: 36px;">
					...
					<p>
						...
						${dhs.societyHistoryTime}&nbsp;${dhs.societyHistoryContent}。
		...
		<!--社团成员介绍-->
		<c:forEach var="snt" items="${societyNumberLists}">
				<div class="location">
					<span>当前位置：
					<a href="#">成员介绍</a>
					</span>
					<div style="font-size:18px;" class="brief" id="b">
						<a href="#">${snt.societyNumberTerm}届计协干部</a>
					</div>
				</div>
				<div style="font-size: 14px; margin-top: 53px; line-height: 36px;">
						...
						<div id="tab_con_4" class="dis-n" style="display: block;">
							<table class="contact">
								<tbody>
									<c:forEach var="snl" items="${snt.societyNumbers}">
									<tr>
										<td width="18%" class="ct_bg">
											${snl.societyNumberDepartment}
										</td>
										<td>
											${snl.societyNumberOldMember}&nbsp;${snl.societyNumberYoungerMember}
										</td>
									</tr>
							...
							<div id="tab_con_4" class="dis-n" style="display: block;">
								<table class="contact">
									...
									<c:forEach var="cif" items="${contactInformations}">
										<tr>
											<td width="18%" class="ct_bg">
												${cif.contactInformationName}
											</td>
											<td>
												${cif.contactInformationContant}
											</td>
										</tr>
									</c:forEach>	
