...
import org.hnist.FileCommon.FileOperation;
	...
	public String showIndexImages(Model model, HttpSession session) {
		...
		try{
			...
			if(imagess.size()<=0){
				...
				Images image=imagess.get(0);
				image.setImg01(image.getImg01().replace("upload", "foxjixieupload"));
				image.setImg02(image.getImg02().replace("upload", "foxjixieupload"));
				image.setImg03(image.getImg03().replace("upload", "foxjixieupload"));
				image.setImg04(image.getImg04().replace("upload", "foxjixieupload"));
				image.setImg05(image.getImg05().replace("upload", "foxjixieupload"));
